						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="pur_invoice_id"><?php echo _l('pur_invoice'); ?></label>
									<select name="pur_invoice_id" id="pur_invoice_id" class="selectpicker" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
										<option value=""></option>
										<?php if(isset($pur_invoices)){ foreach($pur_invoices as $pi) { ?>
											<option value="<?php echo html_entity_decode($pi['id']); ?>" <?php if(isset($goods_receipt) && ($goods_receipt->pur_invoice_id == $pi['id'])){ echo 'selected' ;} ?>><?php echo html_entity_decode($pi['invoice_number']); ?></option>
										<?php } } ?>
									</select>
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select  name="supplier_code" id="supplier_code" class="selectpicker" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
										<option value=""></option>
										<?php if(isset($vendors)){ foreach($vendors as $s) { ?>
							...
							<!-- <div class="col-md-6">
								...
								<?php echo render_input('supplier_name','supplier_name', $supplier_name) ?>
							</div> -->
