...
class Accounting_model extends App_Model
{
    ...
    public function get_account_types()
    {
        $account_types = hooks()->apply_filters('before_get_account_types', [
            ...
            ['id'    => 16,'name'  => 'ASSETS','order' => 16,    ],
            ['id'    => 17,'name'  => 'Current Assets','order' => 17,    ],
            ['id'    => 18,'name'  => 'Cash at Bank','order' => 18,    ],
            ['id'    => 19,'name'  => 'Non-Current Assets','order' => 19,    ],
            ['id'    => 20,'name'  => 'Accumulated Depreciation','order' => 20,    ],
            ['id'    => 21,'name'  => 'LIABILITIES','order' => 21,    ],
            ['id'    => 22,'name'  => 'Current Liabilities','order' => 22,    ],
            ['id'    => 23,'name'  => 'Taxes Payable','order' => 23,    ],
            ['id'    => 24,'name'  => 'Non-Current Liabilities','order' => 24,    ],
            ['id'    => 25,'name'  => 'EQUITY','order' => 25,    ],
            ['id'    => 26,'name'  => "Owner's / Share Capital",'order' => 26,    ],
            ['id'    => 27,'name'  => 'REVENUE','order' => 27,    ],
            ['id'    => 28,'name'  => 'Sales Revenue','order' => 28,    ],
            ['id'    => 29,'name'  => 'Other Income','order' => 29,    ],
            ['id'    => 30,'name'  => 'COST OF SALES / COGS','order' => 30,    ],
            ['id'    => 31,'name'  => 'Cost of Goods Sold','order' => 31,    ],
            ['id'    => 32,'name'  => 'OPERATING EXPENSES','order' => 32,    ],
            ['id'    => 33,'name'  => 'Selling & Distribution Expenses','order' => 33,    ],
            ['id'    => 34,'name'  => 'Administrative Expenses','order' => 34,    ],
            ['id'    => 35,'name'  => 'Repairs & Maintenance','order' => 35,    ],
            ['id'    => 36,'name'  => 'Professional Expenses','order' => 36,    ],
            ['id'    => 37,'name'  => 'Depreciation & Amortization','order' => 37,    ],
            ['id'    => 38,'name'  => 'Travel & Conveyance','order' => 38,    ],
            ['id'    => 39,'name'  => 'Bank & Finance Charges','order' => 39,    ],
            ['id'    => 40,'name'  => 'Other Operating Expenses','order' => 40,    ],
            ['id'    => 41,'name'  => 'TAX EXPENSE','order' => 41,    ],
        ]);
    ...
    public function get_columns_budget($budget_id, $budget_type, $only_data = false)
    {
        ...
        if ($only_data) {
            ...
            $columns = [
                ['data' => 'account_name', 'type' => 'text', 'readOnly' => true],
