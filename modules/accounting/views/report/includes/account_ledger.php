          ...
          <div class="row">
            <div class="col-md-10">
              ...
              <?php echo form_open(admin_url('accounting/view_report'),array('id'=>'filter-form')); ?>
                ...
                <div class="col-md-4">
                  <?php echo render_select('accounts[]', $accounts, array('id', 'name'), 'acc_account', '', array('multiple' => true, 'data-actions-box' => true, 'data-live-search' => true), array(), '', '', false); ?>
                </div>
                <div class="col-md-2">
                  <?php
                  $method = [
                ...
                <div class="col-md-2">
                  <?php echo form_hidden('type', 'account_ledger'); ?>
