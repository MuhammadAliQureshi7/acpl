        ...
        foreach ($rResult as $aRow) {
            ...
            if ($aRow['status_name'] == null) {
                ...
                if (!$locked) {
                    ...
                    $outputStatus .= '<a href="#" style="font-size:11.2px;vertical-align:middle;" class="dropdown-toggle text-dark" id="tableLeadsStatus-' . $aRow['id'] . '" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">';
