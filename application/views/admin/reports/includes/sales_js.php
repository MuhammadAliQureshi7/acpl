...
<script>
  ...
  var report_customerswise = $('#sales-customerswise-report');
  var report_itemswise = $('#sales-itemswise-report');
  var report_principleswise = $('#sales-principleswise-report');
  ...
  function init_report(e, type) {
    ...
    } else if (type == 'sales-customerswise-report') {
      report_customerswise.removeClass('hide');
      customersFilter.removeClass('hide');
    } else if (type == 'sales-itemswise-report') {
      report_itemswise.removeClass('hide');
      itemsFilter.removeClass('hide');
    } else if (type == 'sales-principleswise-report') {
      report_principleswise.removeClass('hide');
      principlesFilter.removeClass('hide');
  ...
  function sales_detail_report(type) {
    var url = 'reports/sales_customerswise_report';
    var contentSel = '#sales-customerswise-report-content';
    if (type == 'itemswise') {
      url = 'reports/sales_itemswise_report';
      contentSel = '#sales-itemswise-report-content';
    } else if (type == 'principleswise') {
      url = 'reports/sales_principleswise_report';
      contentSel = '#sales-principleswise-report-content';
    }
    var data = {
    ...
    if (type == 'customerswise') {
      data.report_customer = $('#customer').val();
    } else if (type == 'itemswise') {
      data.report_item = $('#report-item').val();
    } else if (type == 'principleswise') {
      data.report_principle = $('#report-principle').val();
    }
  ...
  function sales_detail_print(type) {
    var contentSel = '#sales-customerswise-report-content';
    if (type == 'itemswise') {
      contentSel = '#sales-itemswise-report-content';
    } else if (type == 'principleswise') {
  ...
  function gen_reports() {
    ...
    } else if (!report_customerswise.hasClass('hide')) {
      sales_detail_report('customerswise');
    } else if (!report_itemswise.hasClass('hide')) {
      sales_detail_report('itemswise');
    } else if (!report_principleswise.hasClass('hide')) {
      sales_detail_report('principleswise');
