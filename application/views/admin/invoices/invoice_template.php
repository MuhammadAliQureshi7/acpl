        ...
        <div class="row">
            <div class="col-md-6">
                <div class="f_client_id">
                    <div class="form-group select-placeholder">
                        ...
                        <select id="clientid" onchange="get_client_details()" name="clientid" data-live-search="true" data-width="100%" class="ajax-search<?php if (isset($invoice) && empty($invoice->clientid)) {
            ...
            <div class="col-md-6">
                <div class="tw-ml-3">
                    ...
                    <?php echo render_textarea('adminnote', 'invoice_description', $value); ?>
                    <?php $strn = ( isset($invoice) ? $invoice->strn : '');
